...
tumour suppressor (\citeproc{ref-reya2001}{Reya et al. 2001}).
...
comprising only 1-3\% of the total tumour (\citeproc{ref-bao2006}{Bao et
al. 2006}). However, the authors argue that this does not interfere with
...
overall CSC division rate. While (\citeproc{ref-hillen2013}{Hillen,
Enderling, and Hahnfeldt 2013}) only accounts for asymmetric division it
...
2013}) they considered a general differentaition promoter, in
...
radiation than CCs (\citeproc{ref-bao2006}{Bao et al. 2006}). Despite
...
the infiltrating glioma cells (\citeproc{ref-li2014}{Li et al. 2014};
\citeproc{ref-mangraviti2016}{Mangraviti et al. 2016};
\citeproc{ref-pendleton2013}{Pendleton et al. 2013};
...
gliomas (\citeproc{ref-mangraviti2016}{Mangraviti et al. 2016}).
...
(\citeproc{ref-farias}{Farias et al., n.d.}). Five GSC cell lines were
...
implantation of AMSC (\citeproc{ref-li2014}{Li et al. 2014}).
...
n.d.}) which shows that GBM1a, QNS657 and QNS120 are sensitive to BMP4
...
(\citeproc{ref-li2014}{Li et al. 2014}) \\
